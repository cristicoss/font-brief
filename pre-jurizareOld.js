...
// const { createApp, reactive, nextTick } = petite; visible
...
// import _checkUncheck from "./comps/checkUncheck.js"; resetSlider
...
import _uploadImgs from "./jurizare/handleHeaderImgs.js";
import _createFont from "./jurizare/createNewFont.js";
import _changePromoFonts from "./jurizare/handlePromoFonts.js";
...
export class App {
  ...
  constructor(store) {
    ...
    ["hashchange", "load"].forEach((ev) =>
      window.addEventListener(ev, this._readUrl(this.store))
    );
...
const createFontsList = async function () {
  ...
  createApp({
    ...
    handleSearch(e) {
      ...
      this.app._reset();
      this.app._updateUrl([e.target.value], "search");
    },
